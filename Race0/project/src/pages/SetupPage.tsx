        ...
        <div className="p-6 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-purple-50">
          <div className="flex flex-wrap gap-4 items-center">
            {selectedRivals.map(rival => (
              <div key={rival.id} className="flex items-center">
                <img 
                  src={rival.avatar} 
                  alt={rival.name}
                ...
                />
                <span className="ml-2 text-gray-700">{rival.name}</span>
              </div>
            ))}
          </div>
          <div className="mt-4">
            ...
            <p className="text-gray-600">
              You'll be competing against {selectedRivals.length === 1 
                ? selectedRivals[0].name 
                : `${selectedRivals.length} rivals`}
            </p>
          </div>
        </div>
        ...
        <div className="p-6 space-y-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              This is how much time you'll have for each problem. Your rivals' 
          ...
          <div className="bg-blue-50 rounded-lg p-4 border border-blue-100">
            ...
            <ul className="space-y-2 text-sm text-blue-700">
              ...
              <li>• Competing against: {selectedRivals.length === 1 
                ? selectedRivals[0].name 
                : `${selectedRivals.length} rivals (${selectedRivals.map(r => r.name).join(', ')})`}</li>
            </ul>
          </div>
