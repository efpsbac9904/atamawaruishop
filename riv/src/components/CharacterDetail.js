    ...
    return (<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="relative">
          ...
          <button onClick={onClose} className="absolute top-4 right-4 bg-black bg-opacity-30 hover:bg-opacity-50 text-white rounded-full p-1 transition-colors duration-200">
        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            ...
            <div className="bg-gray-50 rounded-lg p-4 border border-gray-100">
              <div className="flex items-start">
                <lucide_react_1.Lightbulb className="h-5 w-5 text-yellow-500 mt-0.5 mr-2 flex-shrink-0"/>
          ...
          <div className="mb-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                <lucide_react_1.Zap className="w-5 h-5 mr-3 text-yellow-500"/>
            ...
            backgroundColor: character.color
              ...
              <div className="flex items-center">
                <lucide_react_1.CheckCircle className="w-5 h-5 mr-3 text-green-500"/>
                <div className="flex-1">
                  <div className="flex justify-between mb-1">
            ...
            backgroundColor: character.color
              ...
              <div className="flex items-center">
                <lucide_react_1.Clock className="w-5 h-5 mr-3 text-blue-500"/>
                <div className="flex-1">
                  <div className="flex justify-between mb-1">
          ...
          <div className="mb-4">
            ...
            <div className="bg-gray-50 rounded-lg p-4 border border-gray-100">
              <div className="flex items-start mb-3">
                <lucide_react_1.AlertTriangle className="h-5 w-5 text-amber-500 mt-0.5 mr-2 flex-shrink-0"/>
                <div>
            ...
            character.stats.accuracy > 8 ? 'precise answers' : 'maintaining steady progress'}.
              ...
              <div className="flex items-start">
                <lucide_react_1.Brain className="h-5 w-5 text-purple-500 mt-0.5 mr-2 flex-shrink-0"/>
                <div>
          ...
          <div className="pt-4 flex justify-end">
            <button onClick={onClose} className="px-4 py-2 bg-gray-100 text-gray-700 rounded-md hover:bg-gray-200 font-medium transition-colors duration-200">
              Close
            </button>
          </div>
        </div>
...
exports.default = CharacterDetail;
