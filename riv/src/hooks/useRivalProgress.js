...
exports.useRivalProgress = void 0;
const react_1 = require("react");
const useRivalProgress = ({ isActive, problemCount, timePerProblem, rival, onProgressUpdate, onComplete }) => {
    const progressIntervalRef = (0, react_1.useRef)();
    const currentProgressRef = (0, react_1.useRef)(0);
...
exports.useRivalProgress = useRivalProgress;
